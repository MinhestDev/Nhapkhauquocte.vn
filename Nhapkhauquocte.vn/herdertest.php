...
<head>
    <title>Nhapkhautoanquoc.vn</title>
    <meta charset="utf-8">
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-md-6" id="header-text">
                            <a>Nhapkhautoanquoc.vn</a><b>Chào mừng đến với website bán hàng của chúng tôi..!! </b>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="container">
                <nav>
                    ...
                    <ul class="pull-right" id="main-shopping">
                        <li>
                            <a href="#"><i class="fa fa-shopping-basket"></i> Giỏ hàng của tôi </a>
                        </li>
                    </ul>
                    <!--end Shopping-->
                </nav>
