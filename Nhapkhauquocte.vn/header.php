...
<head>
    ...
    <!--slide-->
    <link rel="shortcut icon" type="image/png" href="image/icon_website.png" />
        ...
        <nav class="navbar navbar-default" style="background: #F3EADA">
            <div class="container-fluid">
                <div class="navbar-header" style="margin-top: 5px; margin-left: 5px; >
                    <a style=" color: red">CHÀO MỪNG BẠN ĐẾN VỚI WEBSITE CỦA CHÚNG TÔI.!</a>
                </div>
                ...
                <div class="row" id="header-main">
                    <a href="index.php">
                        <div class="col-md-2" style="margin-top: 0px">
                            <img style="width: 220px" src="image/icon-website.png" alt="logo-website">
                        </div>
                    </a>
                    <div>
                        <div class="col-sm-8">
                    ...
                    <div class="col-md-2" id="header-right">
                        <div class="pull-right" style="margin-top:7px">
                            <!-- <div class="pull-left">
                                <img style="margin-right: 20px;margin-top: 5px;" src="public/frontend/images/contact.png">
                            </div> -->
                            <div class="pull-right">
                                <p id="hotline" style="color: #fff"> HOTLINE</p>
                                <p style="color: #fff">0901.510.789 - 0826.689.617</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box-left box-menu">
                        ...
                        <ul>
                            ...
                            <div class="panel-body">
                                <p><span class="glyphicon glyphicon-map-marker"></span> 20 Ng. 785 Đ. Nguyễn Khoái, Thanh Trì, Hoàng Mai, Hà Nội, Việt Nam</p>
                            </div>
                            <div class="panel-body">
                                <p><span class="glyphicon glyphicon-phone"></span>0901.510.789 - 0826.689.617</p>
                            </div>
                            <div class="panel-body">
